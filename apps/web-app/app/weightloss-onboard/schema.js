...
export const noBackScreens = new Set([
...
export const formSchema = z.object({
  ...
  photoIdPath: z.string(),
  photoIdContentType: z.string(),
  vialPhotoPath: z.string(),
  vialPhotoContentType: z.string(),
  s9: z.array(z.string()),
  bariDate: z.string(),
  ...
  paymentAuthorizedAt: z.number().nullable().optional(),

  couponCode: z.string().optional(),
  couponId: z.string().optional(),
  couponDiscountPercent: z.number().nullable().optional(),
  couponDiscountAmount: z.number().optional(),
  paymentBaseAmount: z.number().nullable().optional(),
});
